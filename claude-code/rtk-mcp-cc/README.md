...
Installing this plugin adds **≥ 3,690 bytes** to every request, for the whole session. A further **≥ 6,091 bytes** load only when one of its skills or agents is actually invoked.
