// M2d set_local e2e. Gated by GHIDRA_MCP_E2E=1. Run from PowerShell, -j1 (single JVM per worker):
//   $env:GHIDRA_MCP_E2E="1"; cargo nextest run -p ghidra-mcp --test setlocal -j1
mod common;
use common::*;
