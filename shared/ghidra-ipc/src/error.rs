...
impl ErrorCode {
    ...
    pub fn suggested_action(self) -> &'static str {
        match self {
            ...
            ErrorCode::WorkerIncompatible => "the worker script is incompatible with this host; reinstall the plugin",
            ...
            ErrorCode::GhidraNotFound => "GHIDRA_INSTALL_DIR is unset or invalid; point it at your Ghidra install root",
